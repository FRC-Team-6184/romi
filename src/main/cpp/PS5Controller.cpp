...
bool PS5Controller::GetShareButton() const
{
    return GetRawButton(Button::kShare);
}

bool PS5Controller::GetShareButtonPressed()
{
    return GetRawButtonPressed(Button::kShare);
}

bool PS5Controller::GetShareButtonReleased()
{
    return GetRawButtonReleased(Button::kShare);
}

BooleanEvent PS5Controller::Share(EventLoop *loop) const
{
    return BooleanEvent(loop, [this]()
